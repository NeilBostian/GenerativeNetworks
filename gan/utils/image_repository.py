...
class ImageRepository():
    """
    Helper class to convert a series of image files into a tfrecords file for
    streamlined tensor-based IO. Provides access to the images via a tf.data.Dataset object.
    """
